...
gulp.task('stylus', function() {
    gulp.src(path.src+'/css/main.styl')
    .pipe(plumber())
    .pipe(stylus({
...
gulp.task('watch', function() {
    livereload.listen();
    gulp.watch(path.src+'/css/*.styl', ['stylus']);
...
// Task
gulp.task('default', ['js','stylus', 'imagemin', 'watch', 'browser-sync','browserify']);
